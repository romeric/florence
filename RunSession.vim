...
nnoremap ,ss :wq
nnoremap ,s :w
noremap ,cu :silent s/\V\^=escape(get(split(&commentstring,'%s'),0,''),'\/').'\|'.escape(get(split(&commentstring,'%s'),1,''),'\/')\$//g:nohlsearch
noremap ,cc :silent s/\V\.\*/\=printf(&commentstring,getline("."))/:nohlsearch
nnoremap df :%d
nmap gx <Plug>NetrwBrowseX
nnoremap tnew :tabnew
nnoremap tn :tabnext
...
badd +1 Core/FiniteElements/PostProcess.py
badd +52 Core/FiniteElements/ApplyDirichletBoundaryConditions.py
badd +52 Core/FiniteElements/ElementalMatrices/ElementalStiffness.py
badd +47 ~/.vimrc
