...
def duplicate(ar,decimals=10,tol=1e-14):
    """Find duplicated rows in a 2D floating point array with shape N x 2.

        input:  
            ar:             2D array
            Decimals:       Precision for equality
            tol:            Tolerance for equality

        returns:
            duplicates:     A tuple of numpy arrays with each array containing the ducplicate rows"""
