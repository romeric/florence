...
from scipy.sparse.sputils import upcast, isintlike, IndexMixin, issequence, get_index_dtype
...
class csr_matrix(_cs_matrix, IndexMixin):
    ...
    def __getitem__(self, key):
        ...
        def extractor(indices,N):
            ...
            indptr = da.arange(len(indices)+1, dtype=indices.dtype, chunks=self.chunks)
