...
class OCCPlugin: public PostMeshBase
{
public:
    // CONSTRUCTOR
    OCCPlugin(){}
...
////        this->ndim = dim;
////        std::cout << this->ndim << std::endl;

//        this->condition = 1.0e10;
//        this->scale = 1.;
//    }
    OCCPlugin(std::string &element_type, const UInteger &dim) : PostMeshBase(element_type,dim) {}

    ~OCCPlugin(){}

    // Public data members of OCCPlugin
