...
# IMPORTANT INFO
#--------------------------------------------------------------------------------------------------#
# 1. THE PURE PYTHON MESH READER IS REASONABLY FAST FOR VERY SMALL MESH DATA (E.G. 5000 TRIS, 3000TETS).
# 
...
# FOR INSTANCE, FOR A MESH SIZE WITH 382526 TRIANGULAR ELEMENTS AND A FILE SIZE OF 20.8MB THE COMPARATIVE TIMING 
...
# ACCORDING TO NUMPY'S DOCUMENTAION NP.FROMFILE IS A HIGHLY EFFICIENT WAY OF READING BINARY DATA THAT
