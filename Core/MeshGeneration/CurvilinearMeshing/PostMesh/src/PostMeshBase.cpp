...
void PostMeshBase::Init(std::string &etype, const UInteger &dim)
{
...
void PostMeshBase::SetDimension(const UInteger &dim)
{
    this->ndim=dim;
}

void PostMeshBase::SetMeshElementType(std::string &type)
{
    this->mesh_element_type = type;
}

void PostMeshBase::SetMeshElements(UInteger *arr, const Integer &rows, const Integer &cols)
{
    this->mesh_elements = Eigen::Map<Eigen::MatrixUI>(arr,rows,cols);
}

void PostMeshBase::SetMeshPoints(Real *arr, const Integer &rows, const Integer &cols)
{
...
void PostMeshBase::SetMeshEdges(UInteger *arr, const Integer &rows, const Integer &cols)
{
    this->mesh_edges = Eigen::Map<Eigen::MatrixUI>(arr,rows,cols);
}

void PostMeshBase::SetMeshFaces(UInteger *arr, const Integer &rows, const Integer &cols)
{
    this->mesh_faces = Eigen::Map<Eigen::MatrixUI>(arr,rows,cols);
}

void PostMeshBase::ScaleMesh()
{
