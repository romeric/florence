...
class MainData(object):
 	...
 	__VECTORISATION__ = True				# USE VECTORISED ROUTINES. ACTIVATES SSE SIMD COMPILED NUMPY'S EINSTEIN SUMMATION (EINSUM) FOR
 											# COMPUTING ELEMENTAL MATRICES WITHOUT LOOPING OVER GAUSS POINTS. OTHER UNDER THE HOOD OPTIMISATIONS
 	Parallel = True 						# ACTIVATE MULTI-PROCESSING 
