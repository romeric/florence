...
def ProblemData(MainData):
    ...
    MainData.MeshInfo.ConnectivityFile = ProblemPath + '/elements_rae.dat'
    MainData.MeshInfo.CoordinatesFile = ProblemPath +'/points_rae.dat'
    ...
    MainData.MeshInfo.FileName = ProblemPath + '/RAE2822_P'+str(MainData.C+1)+'.mat'
