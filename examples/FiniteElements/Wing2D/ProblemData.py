...
def ProblemData(MainData=None):
    ...
    # material = NeoHookean_2(ndim,youngs_modulus=1.0e05,poissons_ratio=0.001)
...
def ProblemData_Regularised(MainData=None):
    ...
    # material = IncrementalLinearElastic(ndim,youngs_modulus=1.0e05,poissons_ratio=0.001)
    # material = NeoHookean_2(ndim,youngs_modulus=1.0e05,poissons_ratio=0.001)
    # material = RegularisedNeoHookean(ndim,youngs_modulus=1.0e05,poissons_ratio=0.4)
    # material = MooneyRivlin(ndim,youngs_modulus=1.0e05,poissons_ratio=0.4)
    # material = NearlyIncompressibleMooneyRivlin(MainData.ndim,youngs_modulus=1.0e05,poissons_ratio=0.4)
    # material = BonetTranservselyIsotropicHyperElastic(MainData.ndim,youngs_modulus=1.0e05,poissons_ratio=0.4,
        # E_A=2.5e05,G_A=5.0e04)
    ...
    # CHANGE MATERIAL
    material = RegularisedNeoHookean(ndim,youngs_modulus=1.0e05,poissons_ratio=0.4, Jbar=solution.AverageJacobian)
    fem_solver = FEMSolver(number_of_load_increments=1,analysis_type="static",
...
if __name__ == "__main__":
    ...
    ProblemData_Regularised(MainData)
