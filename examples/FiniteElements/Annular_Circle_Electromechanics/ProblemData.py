...
def ProblemData(MainData=None):
    ...
    np.savetxt("/home/roman/Dropbox/zdump/NATIVE/points.dat",mesh.points, delimiter=",")
    np.savetxt("/home/roman/Dropbox/zdump/NATIVE/elements.dat",mesh.elements, delimiter=",")
    exit()
