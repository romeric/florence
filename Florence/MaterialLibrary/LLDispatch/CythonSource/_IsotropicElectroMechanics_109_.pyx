...
cdef extern from "_IsotropicElectroMechanics_109_.h" nogil:
    cdef cppclass _IsotropicElectroMechanics_109_[Real]:
        _IsotropicElectroMechanics_109_() except +
        _IsotropicElectroMechanics_109_(Real mu_v, Real mu1, Real mu2, Real lamb, Real eps_2) except +
        void SetParameters(Real mu_v, Real mu1, Real mu2, Real lamb, Real eps_2) except +
...
def KineticMeasures(material, np.ndarray[Real, ndim=3, mode='c'] F, np.ndarray[Real, ndim=2] E):
    ...
    cdef _IsotropicElectroMechanics_109_[Real] mat_obj = _IsotropicElectroMechanics_109_()
    mat_obj.SetParameters(material.mu_v,material.mu1,material.mu2,material.lamb,material.eps_2)
