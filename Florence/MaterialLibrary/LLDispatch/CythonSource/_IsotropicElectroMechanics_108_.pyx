...
cdef extern from "_IsotropicElectroMechanics_108_.h" nogil:
    cdef cppclass _IsotropicElectroMechanics_108_[Real]:
        _IsotropicElectroMechanics_108_() except +
        _IsotropicElectroMechanics_108_(Real mu1, Real mu2, Real lamb, Real eps_2) except +
...
def KineticMeasures(material, np.ndarray[Real, ndim=3, mode='c'] F, np.ndarray[Real, ndim=2] E):
    ...
    cdef _IsotropicElectroMechanics_108_[Real] mat_obj = _IsotropicElectroMechanics_108_()
