...
cdef extern from "_IsotropicElectroMechanics_3_.h" nogil:
    cdef cppclass _IsotropicElectroMechanics_3_[Real]:
        _IsotropicElectroMechanics_3_() except +
        _IsotropicElectroMechanics_3_(Real mu, Real lamb, Real eps_1, Real eps_2) except +
        void SetParameters(Real mu, Real lamb, Real eps_1, Real eps_2) except +
...
def KineticMeasures(material, np.ndarray[Real, ndim=3, mode='c'] F, np.ndarray[Real, ndim=2] E):
    ...
    cdef _IsotropicElectroMechanics_3_[Real] mat_obj = _IsotropicElectroMechanics_3_()
    mat_obj.SetParameters(material.mu,material.lamb,material.eps_1,material.eps_2)
