...
cdef extern from "_IsotropicElectroMechanics_106_.h" nogil:
    cdef cppclass _IsotropicElectroMechanics_106_[Real]:
        _IsotropicElectroMechanics_106_() except +
        _IsotropicElectroMechanics_106_(Real mu1, Real mu2, Real lamb, Real eps_1, Real eps_2) except +
...
def KineticMeasures(material, np.ndarray[Real, ndim=3, mode='c'] F, np.ndarray[Real, ndim=2] E):
    ...
    cdef _IsotropicElectroMechanics_106_[Real] mat_obj = _IsotropicElectroMechanics_106_()
