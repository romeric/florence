...
template<typename U>
class _IsotropicElectroMechanics_0_ : public _MaterialBase_<U> {
public:
    U mu;
    U lamb;
    U eps_1;
    ...
    _KineticMeasures_(const T *Fnp, const T *Enp) {
        ...
        Tensor<T,ndim,ndim> dielectric = -eps_1*I;
...
template<> template<>
void _IsotropicElectroMechanics_0_<Real>::KineticMeasures<Real>(Real *Dnp, Real *Snp, Real* Hnp,
