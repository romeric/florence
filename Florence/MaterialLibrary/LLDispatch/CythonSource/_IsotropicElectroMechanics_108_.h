...
template<typename U>
class _IsotropicElectroMechanics_108_: public _MaterialBase_<U> {
public:
    U mu1;
    U mu2;
    U lamb;
    ...
    _IsotropicElectroMechanics_108_() = default;

    FASTOR_INLINE
    _IsotropicElectroMechanics_108_(U mu1, U mu2, U lamb, U eps_2) {
        this->mu1 = mu1;
        this->mu2 = mu2;
        this->lamb = lamb;
        this->eps_2 = eps_2;
