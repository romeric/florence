...
def HighOrderMeshTri_UNSTABLE(C,mesh,Decimals=10,Parallel=False,nCPU=1,ComputeAll=False):
    ...
    repoints2 = repoints[idx_repoints,:]
    ...
    reelements2 = unique_reelements[inv_reelements]
    reelements2 = reelements2.reshape(mesh.elements.shape[0],renodeperelem-3) 
    reelements2 = np.concatenate((mesh.elements,reelements2),axis=1)
    ###########
