...
def HighOrderMeshQuad(C,mesh,Parallel=False,nCPU=1):
	...
	import Florence.Core.ParallelProcessing.parmap as parmap
	import Florence.Core.InterpolationFunctions.TwoDimensional.Quad.QuadLagrangeGaussLobatto as TwoD 
