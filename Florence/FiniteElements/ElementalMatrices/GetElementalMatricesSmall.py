...
def GetElementalMatricesSmall(elem,MainData,material,elements,points,Eulerx,TotalPot):
    # ALLOCATE
    ...
    if MainData.__VECTORISATION__ is True:
        ...
        stiffnessel, t = Stiffness_NonVectorised(MainData,material,LagrangeElemCoords,EulerElemCoords,ElectricPotentialElem,elem)
